...
/**
 * {@link HistogramPanel} for headAngle.
 *
 * @author Eric Trautman
 */
public class HeadAngleHistogramPanel extends HistogramPanel {
    ...
    public List<Double> getThresholdValues() {
        ...
        if (parameters != null) {
            thresholdValues.add(parameters.getMinHeadAngleForCasting());
            thresholdValues.add(parameters.getMinHeadAngleToContinueCasting());
            thresholdValues.add(parameters.getMinHeadAngleToContinueTurning());
        }
    ...
    public double getValue(int index) {
        ...
        return Math.abs(data.getHeadAngle());
    }
}
